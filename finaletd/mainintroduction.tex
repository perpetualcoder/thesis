...
These references are very dangerous as one does not know what the reference points to. If the reference points to some other object, then computation might yield undesired output or may crash because of the mismatch in type information of new object allocated in the same address. 
